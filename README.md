...
I need mod creators, regular users, and fire mages to assist in testing this plugin. A few people cannot ensure the plugin's stability. 

### How to contribute:
1. View our roadmap and current progress at the [Project](https://github.com/users/shoushou1106/projects/3).
2. Look for tasks currently marked with the **"In review"** status.
3. Test those specific features and report your results in the corresponding Issue, letting me know if the magic flows perfectly or if there are any issues. Every bit of data helps!

If you would like to contribute but encounter problems or are unclear about the testing process, please reach out to me:
